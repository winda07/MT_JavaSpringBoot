...
(1,	3,	8000000,	'2022-10-02'),
(2,	1,	12000000,	'2022-11-07'),
(3,	2,	17000000,	'1998-11-21');
...
(1,	'martabak manis',	'makanan',	70000),
(2,	'martabak telor',	'makanan',	75000),
(3,	'thai tea',	'minuman',	10000);
...
(1,	'wan',	'jalan mawar',	'Laki-laki',	'1992-10-02',	'Aktif',	'1234567891234',	'Staff'),
(2,	'nia',	'jalan melati',	'Perempuan',	'1992-11-07',	'Aktif',	'0857484875152',	'Staff'),
(3,	'ray',	'jalan beringin',	'Laki-laki',	'1989-01-02',	'Aktif',	'0258498715154',	'Supervisor');
...
(1,	'cooooo',	'jalan mayang',	'Laki-laki',	'1998-11-21',	'Aktif',	2147483647,	'pengusaha'),
(2,	'win',	'Syrup Village',	'Perempuan',	'1995-06-13',	'Tidak Aktif',	2147483647,	'karyawan swasta'),
